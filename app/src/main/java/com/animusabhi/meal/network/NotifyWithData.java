...
public class NotifyWithData extends Worker {

    public static final String TAB = NotifyWithData.class.getSimpleName();
    public static final String EXTRA_TITLE = "title";
    public static final String EXTRA_TEXT = "text";
    public static final String EXTRA_OUTPUT_MESSAGE = "output_message";


    public NotifyWithData(@NonNull Context context, @NonNull WorkerParameters workerParams) {
